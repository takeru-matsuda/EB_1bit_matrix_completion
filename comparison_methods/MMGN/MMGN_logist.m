function [U, V, relerr, relchange, obj, alphas,nBacktracks] = MMGN_logist(Y, ind_omega, sigma, R, U0, V0, M,varargin)
...
%               is small (say less than 0.2) and the target rank is small (say less than 5).
...
beta = 0.5;
gamma = 0.9;
L = 1/(4*sigma^2); % this is specific to the logistic model
